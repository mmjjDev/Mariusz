...
module.exports = (client, int) => {
    ...
    switch (int.customId) {
        ...
        break
        case 'time': {
            if (!queue || !queue.playing) return int.reply({ content: `Aktualnie nic nie jest odtwarzane!`, ephemeral: true, components: [] });
        ...
        break
        case 'twojaStara' : {
            return int.reply({ content: `Odblokowano osiągnięcie - "Wypierdalaj :D:D:D"`, ephemeral : true })
        }
    }
};
